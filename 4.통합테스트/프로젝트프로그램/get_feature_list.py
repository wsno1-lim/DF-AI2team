...
folder_adress = 'C:/Users/wsno1/Desktop/DF_project/AI2-team_project/project_Final/report준비자료/최종리포트'
...
def get_trading_trend_fix() :
    samsung_etc = pd.read_csv(folder_adress+'/trading_trend.csv',parse_dates=['date'])
